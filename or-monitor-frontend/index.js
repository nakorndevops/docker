...
const SSL_KEY_FILENAME = 'or-monitor-frontend.key';
const SSL_CERT_FILENAME = 'or-monitor-frontend.crt';
 ...
 */
app.get('/patientMonitor', (req, res) => {
...
app.get('/checkpoint', (req, res) => {
  const filePath = path.join(__dirname, 'checkpoint.html');
